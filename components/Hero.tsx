        ...
        >
          ...
          >
            <img 
              ...
              onError={(e) => { 
                (e.target as HTMLImageElement).src = 'https://picsum.photos/seed/monarca/600/600'; 
              }}
            />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative bg-neon text-black px-14 py-6 rounded-xl font-black italic uppercase tracking-widest transition-all duration-300 text-xl overflow-hidden"
            >
